...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setForeground(new java.awt.Color(5, 5, 5));
        ...
        jLabel6.setText("Don't Have a account yet? Create a New account");
    ...
    private void jToggleButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jToggleButton1MouseClicked
        ...
        if(nm.equals("Akshat") && pass.equals("akshat123")){
            ...
            String smt = "select * from person where `Firstname`='" + nm + "' and `Password`='"+pass+"';";
            ...
            if (!rs.isBeforeFirst() ) {    
                ...
                if(rs.getString("role").equals("user")){
                    this.setVisible(false);
                    UserFrame ufrm = new UserFrame(rs.getInt("PID"), rs.getString("Firstname"));
                    //ufrm.userName(nm);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                ImageIcon imageIcon = new ImageIcon(new ImageIcon("logo.png").getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT));
            }
        });
    }
